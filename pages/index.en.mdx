...
## Pier Wallet as a Service platform

Pier Wallet as a Service platform is a platform that allows you to create wallets, sign transactions and interact with the blockchain. It is a fully managed service that allows you to focus on your business logic and not worry about the underlying infrastructure. It is a multi-tenant platform, meaning that multiple customers can use the same platform, but their data is isolated from each other.
...
- Capacitor based Native iOS & Android App
- Fully integrated with PIER SDK

### PIER Account Abstraction Wallet as a Service | Features & varia

- Multisig authorization
- Account recovery with 2FA
- Account recovery with Guardians
- Account recovery with default Guardian
- Subsidized (gasless from the user perspective) transactions
- Codes to mint Tokens & other NFTs

### PIER Multi Party Computation Wallet as a Service | Features & varia

- Key Sharding
- Transaction co-signing with n/m signatures
- Account recovery with n/m signatures
