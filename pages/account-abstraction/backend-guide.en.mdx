...
The main motivation to use pier SDK in your backend is, if you want to do one of the following:
...
Using pier wallet SDK in your backend is pretty straight forward. You'll need to do the following:
